<template>
  ...
  >
    ...
    >
      ...
      <el-table-column prop="name" label="名称" width="300" show-tooltip-when-overflow />
      <el-table-column prop="type" label="类型" width="150" />
      <el-table-column prop="component" label="组件" min-width="300" show-tooltip-when-overflow />
    </el-table>
  </VDialog>
